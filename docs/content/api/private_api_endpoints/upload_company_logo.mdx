...
|----------------|-------------|--------------------------------------------------------------------------------------------------------------------------------------|
| `company_slug` | `mandatory` | The unique slug of the company whose logo you wish to update (or introduce). You can obtain this from the `Fetch Companies` endpoint |
