...
|------------|-------------|----------|----------------------------------------------------|
| `name`     | `mandatory` | `string` | Name of the company                                |
| `slug`     | `mandatory` | `string` | URL-friendly slug                                  |
| `country`  | `mandatory` | `string` | The country the company is headquartered in        |
| `industry` | `mandatory` | `string` | The industry the company predominantly operates in |
