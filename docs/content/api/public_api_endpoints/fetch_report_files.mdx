...
|-------------|----------|-----------------------------------------------------------------------|
| `file_size` | `float`  | Floating-point number representing the size of the file, in megabytes |
| `file_name` | `string` | Name of the report                                                    |
| `file_type` | `string` | File type, in lowercase                                               |
